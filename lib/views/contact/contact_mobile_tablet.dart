...
class ContactMobileTablet extends StatefulWidget {
  const ContactMobileTablet({Key? key}) : super(key: key);

  @override
  _ContactMobileTabletState createState() => _ContactMobileTabletState();
}

class _ContactMobileTabletState extends State<ContactMobileTablet>
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: () {
                  js.context
                      .callMethod("open", ["https://github.com/Satyam0988/"]);
                },
