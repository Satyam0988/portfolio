...
class BlogsMobileTablet extends StatefulWidget {
  const BlogsMobileTablet({Key? key}) : super(key: key);

  @override
  _BlogsMobileTabletState createState() => _BlogsMobileTabletState();
}

class _BlogsMobileTabletState extends State<BlogsMobileTablet> {
