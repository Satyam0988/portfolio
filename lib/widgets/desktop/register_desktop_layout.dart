...
class RegisterDesktopLayout extends StatefulWidget {
  const RegisterDesktopLayout({Key? key}) : super(key: key);

  @override
  _RegisterDesktopLayoutState createState() => _RegisterDesktopLayoutState();
}

class _RegisterDesktopLayoutState extends State<RegisterDesktopLayout> {
