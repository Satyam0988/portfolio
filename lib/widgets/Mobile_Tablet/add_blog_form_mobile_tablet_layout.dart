...
class AddBlogFormMobileTabletLayout extends StatefulWidget {
  const AddBlogFormMobileTabletLayout({Key? key}) : super(key: key);

  @override
  _AddBlogFormMobileTabletLayoutState createState() =>
      _AddBlogFormMobileTabletLayoutState();
}

class _AddBlogFormMobileTabletLayoutState
    extends State<AddBlogFormMobileTabletLayout> {
